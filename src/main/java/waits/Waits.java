...
public class Waits {
    ...
    public static WebDriver waitToBeVisibleForFrame(WebDriver driver, WebElement frame){
        return new WebDriverWait(driver, 10).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(frame));
    }
